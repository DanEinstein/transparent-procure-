    ...
    fetch(`${import.meta.env.VITE_API_BASE_URL}/contractors`)
      ...
      .then((data) => {
        ...
        const highRisk = data.filter(
          (c) => c.trust_score < 80 || c.risk_level?.includes("High"),
        );
      ...
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">
            Blacklisted Contractors Summary
          </h1>
          <p className="text-slate-500 font-medium mt-1 uppercase tracking-widest text-xs">
            Identity Control Module — Active Suspensions based on Civic Feed &
            Audit Alerts
          </p>
        </div>
