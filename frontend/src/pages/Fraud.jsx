...
export default function Fraud() {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_API_BASE_URL}/tenders`)
      ...
      .then((data) => {
        ...
        const flaggedTenders = parsedData.filter(
          (t) =>
  ...
  const totalFlaggedValue = anomalies.reduce(
    ...
    <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar bg-background-dark text-slate-200">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          ...
          <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest bg-danger/20 text-danger border border-danger/30 animate-pulse">
            LIVE OVERSIGHT
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-surface-dark border border-slate-800 p-5 rounded-xl shadow-sm">
          ...
          <div className="flex items-baseline gap-2">
            <h3 className="text-3xl font-black text-white">
              {(totalFlaggedValue / 1000000).toFixed(1)}M
            </h3>
        ...
        <div className="bg-surface-dark border border-slate-800 p-5 rounded-xl shadow-sm">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <h3 className="text-3xl font-black text-white">
              {new Set(anomalies.map((a) => a.contractor_id)).size}
            </h3>
          </div>
          <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest font-bold">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-900 border-b border-slate-800">
                  <th className="px-4 py-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">
                    Project Name
                  </th>
                  <th className="px-4 py-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">
                    Quoted Price
              ...
              <tbody className="divide-y divide-slate-800">
                {anomalies.length > 0 ? (
                  ...
                  <tr>
                    ...
                    >
                      No price anomalies detected in the current procurement
                      cycle.
                    </td>
                  </tr>
                )}
          ...
          <div className="bg-surface-dark border border-slate-800 rounded-xl overflow-hidden flex flex-col h-[520px]">
            ...
            <div className="flex-1 relative bg-[#0a0f1a] overflow-hidden group">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                ...
                <span className="mt-2 text-[10px] font-bold text-white bg-slate-900/80 px-2 py-0.5 rounded backdrop-blur-sm">
                  TARGET ENTITY
                </span>
              </div>
              <div className="absolute top-[30%] left-[20%] -translate-x-1/2 -translate-y-1/2">
                ...
                <span className="mt-1 block text-[8px] text-slate-400 text-center">
                  Dir. J. Kamau
                </span>
              </div>
